...
- **These events happened on the firsty try**: Assume a finite probability space generated by a uniformly shuffled standard deck of 52 cards.
- **Order Matters**: Let the ordered draws be $$\(X_1, X_2, X_3, X_4\)$$, each revealing rank and suit.
- **Sampling Without Replacement**: Draws that have already been made can not happen a second time.
