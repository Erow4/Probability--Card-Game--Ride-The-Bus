...
This project focuses on the final phase of the game, coined "riding the bus". I use simulation to come up with the probability of correctly guessing all card properties in sequence in on the first try. 
...
50/50 since we begin with a full deck

B:

Leverages the fact that therere is already one card on the table.  
