...
Construct ranks $$(1{:}13)$$, suits $$\(\{S,H,D,C\}\)$$, and colors $$\(\{\text{black},\text{red}\}\)$$ and generate a random permutation `deck_idx` to represent the shuffled deck.
