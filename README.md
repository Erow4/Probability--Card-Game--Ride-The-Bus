...
- **Deck model:** Standard 52-card deck, no jokers, fair shuffle. Assume a finite probability space generated by a uniformly-shuffled standard deck of 52 cards.
  - **Sampling Without Replacement**: Draws that have already been made can not occur a second time. There is also no replacement/reshuffle between guesses.
...
- **Numbering the Ranks:** Using graph theory, set the Ace to a value of 1 and map the card ranks to a set of numbers such that $\{1,\dots,13\}$. 
